...
//@interface StoreAppObject : NSObject
//@end

@interface StoreAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StoreAppObject class]])
		{
			for (NSString *key in [[(StoreAppObject*)o modules] allKeys])
			{
