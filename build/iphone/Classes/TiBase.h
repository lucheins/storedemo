...
// in simulator we redefine to format for StoreApp Developer console
...
{\
	NSString * exceptionName = [@"org.storeapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.storeapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStoreAppNativeItemNone = -1, 
	UIStoreAppNativeItemSpinner = -2,
	UIStoreAppNativeItemProgressBar = -3,
	
	UIStoreAppNativeItemSlider = -4,
	UIStoreAppNativeItemSwitch = -5,
	UIStoreAppNativeItemMultiButton = -6,
	UIStoreAppNativeItemSegmented = -7,
	
	UIStoreAppNativeItemTextView = -8,
	UIStoreAppNativeItemTextField = -9,
	UIStoreAppNativeItemSearchBar = -10,
	
	UIStoreAppNativeItemPicker = -11,
	UIStoreAppNativeItemDatePicker = -12,
	
	UIStoreAppNativeItemInfoLight = -13,
	UIStoreAppNativeItemInfoDark = -14,
	
	UIStoreAppNativeItemDisclosure = -15,
	
	UIStoreAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StoreApp instances of
